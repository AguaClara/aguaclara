...
In an abstract sense, a Python function takes in input values and returns output
values. Similarly, we can apply this definition to a Python class, which takes
in input values and instead returns a Python object that represents the class.
