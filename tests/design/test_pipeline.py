...
pipeline_20 = Pipe(q = 20.0 * u.L / u.s, size = 6 * u.inch,
    next = Elbow(size = 6 * u.inch,
        next = Pipe(size = 6 * u.inch, l = 4 * u.m,
            next = Tee(size = 6 * u.inch)
        )
    )
)

pipeline_60 = Pipe(q = 60.0 * u.L / u.s, size = 6 * u.inch,
    next = Elbow(size = 6 * u.inch,
        next = Pipe(size = 6 * u.inch, l = 4 * u.m,
            next = Tee(size = 6 * u.inch)
        )
...
pipeline_fp = Pipe(size = 6 * u.inch,
    next = Elbow(size = 6 * u.inch,
        next = Pipe(size = 6 * u.inch, l = 4 * u.m,
            next = Tee(size = 6 * u.inch)
        )
