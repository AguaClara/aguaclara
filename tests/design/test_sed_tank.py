...
@pytest.mark.parametrize('actual, expected', [
    ...
    (sed_tank_20.diffuser_w_inner, 2.4437350364451627 * u.cm),
	(sed_tank_60.diffuser_w_inner, 2.4437350364451627 * u.cm),
    ...
    # (sed_tank_20.outlet_man_nd, 1),
	# (sed_tank_60.outlet_man_nd, 1),

    (sed_tank_20.exit_man_orifice_d, 16 * u.mm),
	(sed_tank_60.exit_man_orifice_d, 16 * u.mm),

    (sed_tank_20.plate_l, 0.4618802153517006 * u.m),
	(sed_tank_60.plate_l, 0.4618802153517006 * u.m),

    # (sed_tank_20.outlet_orifice_n, 2),
  ...
  #   (sed_tank_20.outlet_hl, 1),
    ...
    (sed_tank_20.side_slopes_w, 0.47966923076923074 * u.m),
	(sed_tank_60.side_slopes_w, 0.47966923076923074 * u.m),

    (sed_tank_20.side_slopes_h, 0.5716475290261319 * u.m),
	(sed_tank_60.side_slopes_h, 0.5716475290261319 * u.m),
