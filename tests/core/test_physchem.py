...
class GasTest(QuantityTest):
    ...
    def test_density_air(self):
        self.assertWarns(
            UserWarning, pc.density_air, *(1 * u.atm, 28.97 * u.g / u.mol, 273 * u.K)
        )
...
class ReynoldsNumsTest(QuantityTest):
    ...
    def test_re_pipe(self):
        ...
        checks = (
            ((12 * u.m**3 / u.s, 6 * u.m, 0.01 * u.m**2 / u.s), 254.64790894703253),
            (
                (12000 * u.L / u.s, 600 * u.cm, 0.000001 * u.ha / u.s),
                254.64790894703253,
            ),
            ((60 * u.m**3 / u.s, 1 * u.m, 1 * u.m**2 / u.s), 76.39437268410977),
            ((1 * u.m**3 / u.s, 12 * u.m, 0.45 * u.m**2 / u.s), 0.23578510087688198),
        )
        for i in checks:
            with self.subTest(i=i):
                self.assertAlmostEqualQuantity(
    ...
    def test_re_rect(self):
        ...
        checks = (
            ((10 * u.m**3 / u.s, 4 * u.m, 6 * u.m, 1 * u.m**2 / u.s, True), 2.5),
            (
                (8 * u.m**3 / u.s, 10 * u.m, 4 * u.m, 0.6 * u.m**2 / u.s, False),
                1.9047619047619049,
            ),
    ...
    def test_re_rect_warning(self):
        ...
        checks = (
            lambda: pc.re_rect(1 * u.m**3 / u.s, 1 * u.m, 1 * u.m, 1 * u.m**2 / u.s),
            lambda: pc.re_rect(
                1 * u.m**3 / u.s,
                1 * u.m,
                1 * u.m,
        ...
        self.assertWarns(
            UserWarning,
            lambda: pc.re_rect(
                1 * u.m**3 / u.s, 1 * u.m, 1 * u.m, 1 * u.m**2 / u.s, openchannel=False
            ),
        )
...
class FrictionFuncsTest(QuantityTest):
    ...
    def test_fric_pipe(self):
        ...
        checks = (
            ...
            (
                [46 * u.m**3 / u.s, 9 * u.m, 0.001 * u.m**2 / u.s, 0.03 * u.m],
                0.039382681891291252,
            ),
            (
                [55 * u.m**3 / u.s, 0.4 * u.m, 0.5 * u.m**2 / u.s, 0.0001 * u.m],
                0.18278357257249706,
            ),
        )
        for i in checks:
    ...
    def test_fric_rect_range(self):
        ...
        checks = (
            [1 * u.m**3 / u.s, 1 * u.m, 1 * u.m, 1 * u.m**2 / u.s, -1.1 * u.m, True],
        )
        for i in checks:
            with self.subTest(i=i):
    ...
    def test_fric_general(self):
        self.assertWarns(
            UserWarning,
            pc.fric_general,
            *(9 * u.m**2, 0.67 * u.m, 3 * u.m / u.s, 0.987 * u.m**2 / u.s, 0.86 * u.m)
        )
    ...
    def test_fric_channel_range(self):
        ...
        checks = (
            (1 * u.m**2, 1 * u.m, 1 * u.m / u.s, 1 * u.m**2 / u.s, -0.0001 * u.m),
        )
        for i in checks:
            with self.subTest(i=i):
...
class HeadlossFuncsTest(QuantityTest):
    ...
    def test_headloss_fric(self):
        self.assertWarns(
            UserWarning,
            pc.headloss_fric,
            *(100 * u.m**3 / u.s, 2 * u.m, 4 * u.m, 0.001 * u.m**2 / u.s, 1 * u.m)
        )
    ...
    def test_headloss_major_pipe(self):
        ...
        checks = (
            ...
            (
                [100 * u.m**3 / u.s, 2 * u.m, 4 * u.m, 0.1 * u.m**2 / u.s, 1 * u.m],
                10.386744054168654 * u.m,
            ),
            (
                [100 * u.m**3 / u.s, 2 * u.m, 4 * u.m, 0.001 * u.m**2 / u.s, 0 * u.m],
    ...
    def test_headloss_exp(self):
        self.assertWarns(
            UserWarning, pc.headloss_exp, *(60 * u.m**3 / u.s, 0.9 * u.m, 0.067)
        )
    ...
    def test_headloss(self):
        self.assertWarns(
            UserWarning,
            pc.headloss,
            *(100 * u.m**3 / u.s, 2 * u.m, 4 * u.m, 0.001 * u.m**2 / u.s, 1 * u.m, 2)
        )
    ...
    def test_headloss_major_rect_range(self):
        ...
        checks = (
            (1 * u.m**3 / u.s, 1 * u.m, 1 * u.m, 0 * u.m, 1 * u.m**2 / u.s, 1 * u.m, 1),
            (
                1 * u.m**3 / u.s,
                1 * u.m,
                1 * u.m,
    ...
    def test_headloss_fric_general(self):
        self.assertWarns(
            ...
            *(1 * u.m**2, 1 * u.m, 1 * u.m / u.s, 1 * u.m, 1 * u.m**2 / u.s, 1 * u.m)
        )
    ...
    def test_headloss_major_channel_range(self):
        ...
        checks = (
            [1 * u.m**2, 1 * u.m, 1 * u.m / u.s, 0 * u.m, 1 * u.m**2 / u.s, 1 * u.m],
    ...
    def test_headloss_manifold_range(self):
        ...
        failChecks = (
            (1 * u.m**3 / u.s, 1 * u.m, 1 * u.m, 1, 1 * u.m**2 / u.s, 1 * u.m, -1),
            (1 * u.m**3 / u.s, 1 * u.m, 1 * u.m, 1, 1 * u.m**2 / u.s, 1 * u.m, 0),
            (1 * u.m**3 / u.s, 1 * u.m, 1 * u.m, 1, 1 * u.m**2 / u.s, 1 * u.m, 0.1),
        )
        passchecks = (
            (1 * u.m**3 / u.s, 1 * u.m, 1 * u.m, 1, 1 * u.m**2 / u.s, 1 * u.m, 1.0),
    ...
    def test_headloss_manifold_warning(self):
        ...
        error_checks = (
            ...
            lambda: pc.headloss_manifold(
                1 * u.m**3 / u.s, 1 * u.m, 1 * u.m, 1, 1 * u.m**2 / u.s, NumOutlets=1
            ),
            lambda: pc.headloss_manifold(
                1 * u.m**3 / u.s,
                1 * u.m,
    ...
    def test_elbow_minor_loss(self):
        self.assertWarns(
            UserWarning, pc.elbow_minor_loss, *(0.1 * u.m**3 / u.s, 0.1 * u.m, 0.5)
        )
...
class OrificeFuncsTest(QuantityTest):
    ...
    def test_area_orifice(self):
        ...
        checks = (
            ([3 * u.m, 0.4, 0.06 * u.m**3 / u.s], 0.019554886342464974 * u.m**2),
    ...
    def test_num_orifices(self):
        ...
        checks = (
            ([0.12 * u.m**3 / u.s, 0.04, 0.05 * u.m, 2 * u.m], 1 * u.dimensionless),
...
class FlowFuncsTest(QuantityTest):
    ...
    def test_flow_transition(self):
        ...
        checks = (
            ([2 * u.m, 0.4 * u.m**2 / u.s], 1319.4689145077132 * u.m**3 / u.s),
    ...
    def test_flow_hagen_warning(self):
        ...
        warning_checks = (
            lambda: pc.flow_hagen(
                1 * u.m, HeadLossFric=1 * u.m, Length=1 * u.m, Nu=1 * u.m**2 / u.s
            ),
        )
        for i in warning_checks:
            with self.subTest(i=i):
    ...
    def test_flow_swamee_warning(self):
        ...
        error_checks = (
            ...
            lambda: pc.flow_swamee(
                1 * u.m, HeadLossMajor=1 * u.m, Nu=1 * u.m**2 / u.s, Roughness=1 * u.m
            ),
            lambda: pc.flow_swamee(
            ...
            lambda: pc.flow_swamee(
                1 * u.m, HeadLossMajor=1 * u.m, Length=1 * u.m, Nu=1 * u.m**2 / u.s
            ),
        )
        for i in error_checks:
            with self.subTest(i=i):
    ...
    def test_flow_major_pipe(self):
        ...
        checks = (
            ...
            (
                [2 * u.m, 0.62 * u.m, 0.5 * u.m, 0.036 * u.m**2 / u.s, 0.23 * u.m],
    ...
    def test_flow_minor_pipe_range(self):
        ...
        failChecks = ((1 * u.m, -1 * u.m, 1), (1 * u.m, 1 * u.m, 0 * u.dimensionless))
        for i in failChecks:
            with self.subTest(i=i):
    ...
    def test_flow_pipe(self):
        ...
        checks = (
            (
                [0.25 * u.m, 0.4 * u.m, 2 * u.m, 0.58 * u.m**2 / u.s, 0.029 * u.m, 0],
    ...
    def test_flow_pipe_warning(self):
        ...
        warning_checks = (
            lambda: pc.flow_pipe(
                1 * u.m, 1 * u.m, 1 * u.m, 1 * u.m**2 / u.s, PipeRough=1 * u.m, KMinor=1
            ),
        )
        for i in warning_checks:
            with self.subTest(i=i):
...
class DiamFuncsTest(QuantityTest):
    ...
    def test_diam_hagen(self):
        ...
        self.assertAlmostEqualQuantity(
            pc.diam_hagen(
                0.006 * u.m**3 / u.s, 0.00025 * u.m, 0.75 * u.m, 0.0004 * u.m**2 / u.s
            ),
    ...
    def test_diam_swamee_warning(self):
        ...
        error_checks = (
            ...
            lambda: pc.diam_swamee(
                1 * u.m**3 / u.s, Length=1 * u.m, Nu=1 * u.m**2 / u.s, Roughness=1 * u.m
            ),
            lambda: pc.diam_swamee(
                1 * u.m**3 / u.s,
                HeadLossMajor=1 * u.m,
    ...
    def test_diam_pipeminor(self):
        self.assertWarns(
            UserWarning, pc.diam_pipeminor, *(0.008 * u.m**3 / u.s, 0.012 * u.m, 0.93)
        )

    def test_diam_minor_pipe(self):
        """diam_minor_pipe should return known value for known inputs."""
        checks = (
            ([0.008 * u.m**3 / u.s, 0.012 * u.m, 0.93], 0.14229440061589257 * u.m),
            (
    ...
    def test_diam_minor_pipe_range(self):
        ...
        passChecks = ((1 * u.m**3 / u.s, 1 * u.m, 1), (1 * u.m**3 / u.s, 1 * u.m, 0))
        for i in passChecks:
            with self.subTest(i=i):
...
class WeirFuncsTest(QuantityTest):
    ...
    def test_width_weir_rect(self):
        ...
        self.assertAlmostEqualQuantity(
            pc.width_weir_rect(0.005 * u.m**3 / u.s, 0.2 * u.m), 0.03005386871 * u.m
        )
    ...
    def test_headloss_weir_rect(self):
        ...
        self.assertAlmostEqualQuantity(
            pc.headloss_weir_rect(0.005 * u.m**3 / u.s, 1 * u.m), 0.01933289619 * u.m
        )
...
class MiscPhysFuncsTest(QuantityTest):
    ...
    def test_pipe_ID(self):
        ...
        self.assertAlmostEqualQuantity(
            pc.pipe_ID(0.006 * u.m**3 / u.s, 1.2 * u.m), 0.039682379412712764 * u.m
        )
