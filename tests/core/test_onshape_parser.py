...
class OnshapeParserTest(unittest.TestCase):
    def test_parse_quanity(self):
        d0 = {
            ...
            "unitToPower": [{"value": 1, "key": "METER"}],
            "typeTag": "",
        }
        d1 = {
            "value": 0.1414213562373095,
            "unitToPower": [{"value": 3, "key": "MILLIMETER"}],
            "typeTag": "",
        }
        d2 = {
            "value": 0.001414213562373095,
            "unitToPower": [{"value": 1, "key": "METER"}],
            "typeTag": "",
        }
        d3 = {
            "value": 1414.213562373095,
            "unitToPower": [{"value": 1, "key": "METER"}],
            "typeTag": "",
        }
        d4 = {
            "value": 1414213.562373095,
            "unitToPower": [{"value": 2, "key": "METER"}],
            "typeTag": "",
        }
        d5 = {
            "value": 0.00043,
        ...
        self.assertEqual(parse.parse_quantity(d0, False), 0.1414213562373095 * u.m)
    ...
    def test_is_fs_type(self):
        test_json = json.loads(
            '{"type": 2077, "typeName": "BTFSValueMapEntry", "message": {}}'
        )
    ...
    def test_get_parsed_measurements(self):
        ...
        measurements, templates, processes = parse.get_parsed_measurements(
            link, fields=["variables", "template", "process"], for_docs=False
        )
