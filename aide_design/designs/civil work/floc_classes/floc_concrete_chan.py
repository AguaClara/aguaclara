...
class ConcreteChannels:
    """This is a concrete channel class. It's called by the flocculator class so
    that the hierarchy of objects in Python is the same as in Fusion.

    Attributes
    ----------
    These are the default values for a concrete channel assembly. To overwrite, pass these
