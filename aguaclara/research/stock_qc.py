...
class Variable_C_Stock(Stock):
    ...
    >>> from aguaclara.core.units import u
    >>> reactor = Variable_C_Stock(Q_sys = 1*u.mL/u.s, C_sys = 1.4*u.mg/u.L, Q_stock = .01*u.mL/u.s)  # noqa
    >>> reactor.C_stock()
    ...
    def V_super_stock(self, V_stock, C_super_stock):
        ...
        :rtype: float
        """
        return Stock.V_super_stock(self, V_stock, self.C_stock(), C_super_stock)  # noqa
    ...
    def dilution_factor(self, C_super_stock):
        ...
        :return: dilution factor of stock concentration over super stock
        concentration (< 1)
        :rtype: float
        """
...
class Variable_Q_Stock(Stock):
    ...
    >>> from aguaclara.core.units import u
    >>> reactor = Variable_Q_Stock(Q_sys = 1*u.mL/u.s, C_sys = 1.4*u.mg/u.L, C_stock = 7.6*u.mg/u.L)  # noqa
