...
class EntranceTank(Component):
    ...
    def __init__(self, **kwargs):
        self.lfom_nd = (
            2.0 * u.inch
        )  # May be innacurate, check with Monroe -Oliver L., oal22, 4 Jun '19
    ...
    def plate_n(self):
        ...
        num_plates_as_float = np.sqrt(
            (
                self.q
                / (
                    (self.plate_s + self.plate_thickness)
                    * self.floc_chan_w
    ...
    def l(self):  # noqa: E743
        ...
        l = (  # noqa: E741
            ...
            + (
                ...
                * np.cos(((90 * u.deg) - self.plate_angle).to(u.rad))
            )
