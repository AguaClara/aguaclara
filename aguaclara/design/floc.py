...
class Flocculator:
    ...
    def vel_grad_avg(self):
        ...
        return ((con.GRAVITY * self.HL) /
                (viscosity_kinematic(self.temp) * self.GT)).to(u.s ** -1)
    ...
    def w_min_hs_ratio(self):
        ...
        return ((self.HS_RATIO_MIN * self.q.to(u.m ** 3 / u.s) / self.END_WATER_H) *
                (self.BAFFLE_K /
                 (2 * self.END_WATER_H * viscosity_kinematic(self.temp) * self.vel_grad_avg ** 2)) ** (1/3)
                ).to(u.cm)
    ...
    def expansion_h_max(self):
        ...
        0.375 meter
        """
        return (((self.BAFFLE_K / (2 * viscosity_kinematic(self.temp) * (self.vel_grad_avg ** 2))) *
    ...
    def baffle_s(self):
        ...
        return ((self.BAFFLE_K /
                 (2 * self.expansion_h_max * (self.vel_grad_avg ** 2) * viscosity_kinematic(self.temp))) ** (1/3) *
