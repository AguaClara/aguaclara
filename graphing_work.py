...
# of what it would be.
line0mg50 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 50 * u.NTU, coagGraph, 0 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line3mg50 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 50 * u.NTU, coagGraph, 3 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line6mg50 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 50 * u.NTU, coagGraph, 6 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line9mg50 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 50 * u.NTU, coagGraph, 9 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line12mg50 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 50 * u.NTU, coagGraph, 12 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line15mg50 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
...
line0mg100 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 100 * u.NTU, coagGraph, 0 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line3mg100 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 100 * u.NTU, coagGraph, 3 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line6mg100 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 100 * u.NTU, coagGraph, 6 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line9mg100 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 100 * u.NTU, coagGraph, 9 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line12mg100 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 100 * u.NTU, coagGraph, 12 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
line15mg100 = floc.pc_viscous(enerDis, temperature, resTime,
                            tubeDiam, floc.DIAM_CLAY, 
                            floc.DENS_CLAY, 100 * u.NTU, coagGraph, 15 * u.mg/u.L, 
                            floc.HumicAcid, floc.PACl, k, floc.RATIO_HEIGHT_DIAM)
